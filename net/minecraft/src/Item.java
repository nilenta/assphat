...
public class Item {
    ...
    public static Item driedcocaleaf;
    ...
    public static Item fiberglassDust;
    ...
    public static Item asbestosDust;
    public static Item cocaseeds;
    
    
    // new armor
    public static Item helmetFiberGlass;
    public static Item plateFiberGlass;
    public static Item legsFiberGlass;
    public static Item bootsFiberGlass;
    ...
    static {
        ...
        porkCooked = (new ItemFood(64, 8, true)).setIconCoord(4, 14).setItemName("porkchopCooked");
        ...
        // new
        pufferFish = (new ItemFood(15000, -5, true)).setIconCoord(2, 15).setItemName("pufferFish");
        // cocaine
        cocaine = (new ItemCocaine(15001)).setIconCoord(3, 15).setItemName("cocaine");
        cocaleaf = (new Item(15004)).setIconCoord(6, 15).setItemName("cocaleaf");
        
        cocaseeds = (new ItemCocaLeaf(15010)).setIconCoord(9, 15).setItemName("cocaseeds");
        driedcocaleaf = (new Item(15011)).setIconCoord(6, 14).setItemName("driedcocaleaf");
        
        // new sword
        swordGlass = (new ItemSword(15002, EnumToolMaterial.GLASS)).setIconCoord(4, 15).setItemName("swordGlass");
        // fiberglass
        fiberglassDust = (new Item(15003)).setIconCoord(5, 15).setItemName("fiberglassDust"); // (new Item(15003)).setIconCoord(5, 15).setItemName("fiberglassDust");
        
        chickenRaw = (new ItemFood(15005, 2, true)).setIconCoord(2, 14).setItemName("chickenRaw");
        chickenCooked = (new ItemFood(15006, 6, true)).setIconCoord(3, 14).setItemName("chickenCooked");
        beefRaw = (new ItemFood(15007, 3, true)).setIconCoord(5, 14).setItemName("beefRaw");
        beefCooked = (new ItemFood(15008, 8, true)).setIconCoord(8, 5).setItemName("beefCooked");
        
        asbestosDust = (new Item(15009)).setIconCoord(8, 15).setItemName("asbestosDust");
        ...
        test_item = (new Item(12000)).setIconCoord(7, 15).setItemName("test_item");
        
        // armor, above id 15200
        helmetFiberGlass = (new ItemArmor(15200, 0, 5, 0)).setIconCoord(0, 0).setItemName("helmetFiberGlass");
        plateFiberGlass = (new ItemArmor(15201, 0, 5, 1)).setIconCoord(0, 0).setItemName("plateFiberGlass");
        legsFiberGlass = (new ItemArmor(15202, 0, 5, 2)).setIconCoord(0, 0).setItemName("legsFiberGlass");
        bootsFiberGlass = (new ItemArmor(15203, 0, 5, 3)).setIconCoord(0, 0).setItemName("bootsFiberGlass");
