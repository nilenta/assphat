...
public class EntityList {
    ...
    public static Entity createNPCInWorld(World var1, NBTTagCompound var0) {
        Entity var2 = new EntityNPC(var1);
    ...
    static {
        ...
        // new
        addMapping(EntityNPC.class, "NPC", 1001);
        //addMapping(EntityNPC2.class, "NPC2", 1001);
