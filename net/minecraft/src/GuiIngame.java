...
public class GuiIngame extends Gui {
    ...
    public void renderGameOverlay(float var1, boolean var2, int var3, int var4) {
        ...
        int var16;
        int var17;
        if (this.mc.playerController.shouldDrawHUD() && this.mc.thePlayer.playerCapabilities.gameType != 1) {
        ...
        if (this.mc.gameSettings.showDebugInfo) {
            ...
            /*var8.drawStringWithShadow(Helper.getTitle() + " (" + this.mc.debug + ")", 2, 2, 16777215);
            ...
            this.drawDebugTextLeft(var8, Helper.getTitle() + " (" + this.mc.debug + ")", var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoRenders(), var6);
            this.drawDebugTextLeft(var8, this.mc.func_6262_n(), var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoEntities(), var6);
            this.drawDebugTextLeft(var8, this.mc.func_21002_o(), var6);
            this.drawDebugTextLeft(var8, (String)null, var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoLocation(), var6);
            this.drawDebugTextLeft(var8, (String)null, var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoSeed(), var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoTime(), var6);
            this.drawDebugTextLeft(var8, this.mc.debugInfoBiome(), var6);

            if(this.mc.objectMouseOver != null && this.mc.objectMouseOver.entityHit == null) {
                Block playerIndex = Block.blocksList[this.mc.theWorld.getBlockId(this.mc.objectMouseOver.blockX, this.mc.objectMouseOver.blockY, this.mc.objectMouseOver.blockZ)];
                if(playerIndex != null && (playerIndex.blockID > 0 || playerIndex.blockID < Block.blocksList.length)) {
                    this.drawDebugTextLeft(var8, (String)null, var6);
                    this.drawDebugTextLeft(var8, "Harvest: " + "\u00a7" + (this.mc.thePlayer.canHarvestBlock(playerIndex) ? "a" : "c") + this.mc.thePlayer.canHarvestBlock(playerIndex), var6);
                    StringBuilder slotX = new StringBuilder();
                    slotY = this.mc.theWorld.getBlockMetadata(this.mc.objectMouseOver.blockX, this.mc.objectMouseOver.blockY, this.mc.objectMouseOver.blockZ);
                    slotX.append("Block: ");

                    try {
                        slotX.append(StatCollector.translateToLocal(Item.itemsList[playerIndex.blockID].getItemNameIS(new ItemStack(playerIndex, 1, slotY)) + ".name"));
                    } catch (Exception var37) {
                        slotX.append("<ERROR>");
                    }

                    slotX.append(" (" + playerIndex.blockID + (slotY == 0 ? ")" : ""));
                    if(slotY > 0) {
                        slotX.append(":").append(slotY + ")");
                    }

                    this.drawDebugTextLeft(var8, slotX.toString(), var6);
                }
            }
            ...
            long var30 = Runtime.getRuntime().freeMemory();
            long var21 = var29 - var30;
            String var31 = "Used memory: " + var21 * 100L / var24 + "% (" + var21 / 1024L / 1024L + "MB) of " + var24 / 1024L / 1024L + "MB";
            String var32 = "Allocated memory: " + var29 * 100L / var24 + "% (" + var29 / 1024L / 1024L + "MB)";

            this.drawDebugTextRight(var8, var31, var6);

            this.drawDebugTextRight(var8, var32, var6);

            this.drawDebugTextRight(var8, "OS: " + System.getProperty("os.name") + " (" + System.getProperty("os.arch") + ") version " + System.getProperty("os.version"), var6);
            String var891 = "Java: " + System.getProperty("java.version") + ", " + System.getProperty("java.vendor");
            if (GuiMainMenu.getVersion() != 8) {
                var891 = "Java: \u00a7c" + System.getProperty("java.version") + " (CAN BE UNSTABLE)\u00a7f" + ", " + System.getProperty("java.vendor");
            }
            this.drawDebugTextRight(var8, var891, var6);
        	...
        	//var8.drawStringWithShadow(Helper.getTitle(), 2, 2, 16777215);
            this.drawDebugTextLeft(var8, Helper.getTitle(), var6);
        }
    ...
    private void drawDebugTextLeft(FontRenderer fontRenderer, String text, int position) {
        this.drawDebugTextLeft(fontRenderer, text, position, 0xFFFFFF);
    }

    private void drawDebugTextLeft(FontRenderer fontRenderer, String text, int position, int color) {
        if (text == null) {
            this.debugLinesLeft += 0.5F;
        } else {
            int textWidth = fontRenderer.getStringWidth(text);
            if (Helper.mc.gameSettings.showTextBackgroundInF3Menu) {
                this.drawRect(0, (int)(this.debugLinesLeft * 12.0F), textWidth + 4, (int)((this.debugLinesLeft + 1.0F) * 12.0F), Integer.MIN_VALUE);
                fontRenderer.drawString(text, 2, (int)(this.debugLinesLeft * 12.0F + 2.0F), color);
            } else {
                fontRenderer.drawStringWithShadow(text, 2, (int)(this.debugLinesLeft * 12.0F + 2.0F), color);
            }
    ...
    private void drawDebugTextRight(FontRenderer fontRenderer, String text, int position) {
        this.drawDebugTextRight(fontRenderer, text, position, 0xFFFFFF);
    }

    private void drawDebugTextRight(FontRenderer fontRenderer, String text, int position, int color) {
        if (text == null) {
            this.debugLinesRight += 0.5F;
        } else {
            int textWidth = fontRenderer.getStringWidth(text);
            if (Helper.mc.gameSettings.showTextBackgroundInF3Menu) {
                this.drawRect(position - textWidth - 4, (int) (this.debugLinesRight * 12.0F), position, (int) ((this.debugLinesRight + 1.0F) * 12.0F), Integer.MIN_VALUE);
                fontRenderer.drawString(text, position - textWidth - 2, (int)(this.debugLinesRight * 12.0F + 2.0F), color);
            } else {
                fontRenderer.drawStringWithShadow(text, position - textWidth - 2, (int)(this.debugLinesRight * 12.0F + 2.0F), color);
            }
