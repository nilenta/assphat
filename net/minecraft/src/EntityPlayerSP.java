...
public class EntityPlayerSP extends EntityPlayer {
    ...
    public EntityPlayerSP(Minecraft var1, World var2, Session var3, int var4) {
        ...
        if (var3 != null && var3.username != null && var3.username.length() > 0) {
            this.skinUrl = "http://betacraft.uk/MinecraftSkins/" + var3.username + ".png";
        }
    ...
    public void moveEntity(double var1, double var3, double var5) {
    	var1 *= this.speed_boost;
    	var5 *= this.speed_boost;
    	var3 *= this.jump_boost;
    	
    	if (this.sprint) {
    		if (this.moveForward > 0) { // fak u
    			var1 *= 1.6D;
        		var5 *= 1.6D;
    		}
    	}
    ...
    public void updatePlayerActionState() {
        ...
        this.sprint = this.movementInput.sprint;
        this.zoom = this.movementInput.zoom;
    ...
    public void onLivingUpdate() {
        ...
        /*if (this.radiation > this.max_radiation) {
	    	if ((this.tick - this.last_tick) > 5000D) {
	    		this.last_tick = this.tick;
	        	if (!this.radiated) {
	        		this.radiation -= 5; // slowly decay
	        	}
	        	int timesToDamage = (this.radiation - this.max_radiation) / 10;
	        	
	            for (int i = 0; i < timesToDamage; i++) {
	            	this.damageEntity(2);
	                System.out.println("Radiation level is high! Take action!");
	            }
	    	}
	    }*/
    ...
    public void displayDryingTableGUI(int var1, int var2, int var3) {
    	Helper.log("ohmeingyatt");
        this.mc.displayGuiScreen(new GuiDryingTable(this.inventory, this.worldObj, var1, var2, var3));
    }
    ...
    public boolean isSprinting() {
		return this.movementInput.sprint && (this.movementInput.moveForward > 0.0F);
	}
}
