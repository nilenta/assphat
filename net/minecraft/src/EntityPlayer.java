...
public abstract class EntityPlayer extends EntityLiving {
    ...
    public boolean is_speed_boost_enabled = false;
    ...
    public void onUpdate() {
        ...
        if (this.is_speed_boost_enabled) {
        	...
        	if (this.speed_boost_timer > 3600) { // reset after 3 mins
        		this.is_speed_boost_enabled = false;
        		this.speed_boost = 1.0D;
        		this.speed_boost_timer = 0;
        		
        		this.damageEntity(this.cocaine_amount);
        		this.cocaine_amount = 0;
        	}
        }
    }
    ...
    public void updateCloak() {
        this.playerCloakUrl = "http://betacraft.uk/MinecraftCloaks/" + this.username + ".png";
        ...
        if(this.noClip || this.flying) {
			...
			if(this.noClip) {
				if(this.moveForward == 0.0F && this.moveStrafing == 0.0F) {
					...
					this.motionX *= (double)1.8F;
					this.motionZ *= (double)1.8F;
				}
			}
