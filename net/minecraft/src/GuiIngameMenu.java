...
public class GuiIngameMenu extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (Helper.testing_enabled && !this.mc.isMultiplayerWorld()) {
        	this.controlList.add(new GuiButton(7, this.width / 2 - 100, this.height / 4 + 144 + var1, "tests"));
        }
    }
    ...
    protected void actionPerformed(GuiButton var1) {
        ...
        if (var1.id == 7) {
            this.mc.displayGuiScreen(new GuiTests(this, this.mc.statFileWriter));
        }
