...
public class BlockCocaLeaf extends BlockFlower {
    protected BlockCocaLeaf(int var1, int var2) {
        super(var1, var2);
        ...
        if (!var1.multiplayerWorld) {
            for(int var7 = 0; var7 < 3; ++var7) {
                if (var1.rand.nextInt(15) <= var5) {
                    ...
                    EntityItem var12 = new EntityItem(var1, (double)((float)var2 + var9), (double)((float)var3 + var10), (double)((float)var4 + var11), new ItemStack(Item.cocaseeds));
    ...
    public int idDropped(int var1, Random var2) {
        return var1 == 3 ? Item.cocaleaf.shiftedIndex : -1;
    }
