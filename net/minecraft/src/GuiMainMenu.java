...
public class GuiMainMenu extends GuiScreen {
    ...
    public void initGui() {
        /*if(!this.mc.gameSettings.ignoreJavaWarning && getVersion() != 8 && !warningShown) {
            Helper.mc.displayGuiScreen(new GuiWrongJava(this));
        }*/
        ...
        } else if (var1.get(2) + 1 == 5 && var1.get(5) == 30) {
            this.splashText = "Happy birthday, nilenta!";
        }
        ...
        this.controlList.add(new GuiButton(3, this.width / 2 - 100, var4 + 48, 98, 20, "Texture Packs"));
        this.controlList.add(new GuiButton(5, this.width / 2 + 2, var4 + 48, 98, 20, "Credits & Discord"));
    ...
    protected void actionPerformed(GuiButton var1) {
        ...
        if (var1.id == 5) {
            this.mc.displayGuiScreen(new GuiCredits(this, this.updateCounter));
        }
    ...
    public void drawScreen(int var1, int var2, float var3) {
        ...
        GL11.glPopMatrix();
        this.drawString(this.fontRenderer, Helper.getTitle(), 2, 2, 5263440);
        String var9 = "copyright shhhhhhkibidi. do distribute.";
