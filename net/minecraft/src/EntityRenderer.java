...
public class EntityRenderer {
    ...
    private float getFOVModifier(float var1) {
		float var2 = (float)Math.min(System.currentTimeMillis() - this.lastFovUpdate, 10000L) / 1000.0F;
		EntityPlayerSP var3 = this.mc.thePlayer;
		float var4 = 30.0F + this.mc.gameSettings.fov * 90.0F;
		...
		if(var3.health <= 0) {
			...
			var4 /= (1.0F - 500.0F / (var5 + 500.0F)) * 2.0F * 1.0F + 1.0F;
		}
		...
		if(this.fov == 0.0F) {
			...
			this.fov = MathHelper.lerp(this.fov, var4, (float)(1.0D - Math.pow(0.1D, (double)(var2 * 5.0F))));
		}
    ...
    private void orientCamera(float var1) {
        EntityLiving var2 = this.mc.renderViewEntity;
        float var37 = var2.yOffset - 1.62F;
        ...
        double var5 = var2.prevPosY + (var2.posY - var2.prevPosY) * (double)var1; //- (double)var3;
        ...
        if(this.mc.gameSettings.thirdPersonView > 0) {
            ...
            float var13 = 0.0F;
            double var14 = (double) (-MathHelper.sin(var11 / 180.0F * (float) Math.PI) * MathHelper.cos(var12 / 180.0F * (float) Math.PI)) * var9;
            double var16 = (double) (MathHelper.cos(var11 / 180.0F * (float) Math.PI) * MathHelper.cos(var12 / 180.0F * (float) Math.PI)) * var9;
            double var18 = (double) (-MathHelper.sin(var12 / 180.0F * (float) Math.PI)) * var9;
            if (this.mc.gameSettings.thirdPersonView == 2) {
                var14 = (double) (-MathHelper.sin((var11 + 180.0F) / 180.0F * (float) Math.PI) * MathHelper.cos(-var12 / 180.0F * (float) Math.PI)) * var9;
                var16 = (double) (MathHelper.cos((var11 + 180.0F) / 180.0F * (float) Math.PI) * MathHelper.cos(-var12 / 180.0F * (float) Math.PI)) * var9;
                var18 = (double) (-MathHelper.sin(-var12 / 180.0F * (float) Math.PI)) * var9;
            }
            ...
            GL11.glRotatef(var2.rotationYaw - var11 + var13, 0.0F, 1.0F, 0.0F);
        ...
        } else if (var2.isPlayerSleeping()) {
            var37 = (float) ((double) var37 + 1.0D);
        ...
        // udkhfgljksdgfhjksd mjsdc ,nbmsdlmksdvknjsdnjk sdk ojsd gonna kill myself
        this.cloudFog = this.mc.renderGlobal.hasCloudFog(var4, var6, var8, var1);

        //GL11.glRotatef(var2.prevRotationPitch + (var2.rotationPitch - var2.prevRotationPitch) * var1, 1.0F, 0.0F, 0.0F);
        //GL11.glRotatef(var2.prevRotationYaw + (var2.rotationYaw - var2.prevRotationYaw) * var1 + 180.0F, 0.0F, 1.0F, 0.0F);

        /*GL11.glTranslatef(0.0F, var37, 0.0F);
