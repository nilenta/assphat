...
public class ContainerPlayer extends Container {
    ...
    public ContainerPlayer(InventoryPlayer var1, boolean var2) {
        ...
        this.addSlot(new SlotCrafting(var1.player, this.craftMatrix, this.craftResult, 0, 155, 36));

        int var3;
        int var4;
        for(var3 = 0; var3 < 2; ++var3) {
            for(var4 = 0; var4 < 2; ++var4) {
                this.addSlot(new Slot(this.craftMatrix, var4 + var3 * 2, 103 + var4 * 18 + 1, 26 + var3 * 18));
            }
        }
        ...
        /*for(var3 = 0; var3 < 4; ++var3) {
            this.addSlot(new SlotCosmetic(this, var1, var1.getSizeInventory() - 1 - var3, 80, 8 + var3 * 18, var3 + 4));
        }*/
