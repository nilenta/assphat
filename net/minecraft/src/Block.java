...
public class Block {
    ...
    public static final Block dryingTable;
    ...
    // new
    public static final Block cocaPlant;
    public static final Block oreCocaine;
    public static final Block asbestos;
    public static final Block test_block;
    public static final Block fiberglass;
    ...
    public void dropBlockAsItemWithChance(World var1, int var2, int var3, int var4, int var5, float var6) {
        if (!var1.multiplayerWorld) {
            ...
            if (Helper.chance(Helper.random_explosion_chance) && Helper.random_explosions) {
        		var1.createExplosion((Entity)null, var2, var3, var4, Helper.r_float(0.5F, 2.5F));
        	}
    ...
    static {
        ...
        // fiberglass my beloved
        fiberglass = (new BlockFiberglass(170, 78)).setHardness(1.5F).setResistance(10.0F).setStepSound(soundClothFootstep).setBlockName("fiberglass");
        
        // cocaine
        cocaPlant = (new BlockCocaLeaf(171, 136)).setHardness(0.0F).setStepSound(soundGrassFootstep).setBlockName("cocaPlant").disableStats().disableNeighborNotifyOnMetadataChange();
        oreCocaine = (new BlockOre(172, 76)).setHardness(3.0F).setResistance(5.0F).setStepSound(soundStoneFootstep).setBlockName("oreCocaine");
        
        
        asbestos = (new Block(173, 77, Material.rock)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("asbestos");
        
        test_block = (new Block(174, 111, Material.ground)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("test_block");
        ...
        dryingTable = (new BlockDryingTable(175)).setHardness(1.0F).setResistance(10.0F).setStepSound(soundStoneFootstep).setBlockName("dryingTable");
        
        /*
         0-15 at top, 16x16 thingy i think lol
        */
